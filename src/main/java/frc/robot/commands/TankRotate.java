...
public class TankRotate extends Command {
    ...
    private ProfiledPIDController rotationControl = new ProfiledPIDController(0.6, 0, 0, GyroStuff.kAimProfile);
    ...
    public void initialize() {
        ...
        rotationControl.setGoal(Math.sin(Math.toRadians(v_rotation)));
        //rotationControl
    }
