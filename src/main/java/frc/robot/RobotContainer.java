...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        operatorLeftBumper.onTrue(new ShooterKnockShot(s_Shooter).withTimeout(AutoContstants.kPrepareTime)
                .andThen(new ShooterFire(s_Shooter, 0.5)).withTimeout(AutoContstants.kFireTimeAUto)
                .andThen(new ShooterIntake(s_Shooter).withTimeout(1)));
